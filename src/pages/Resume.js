                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <ul>
                                ...
                                <li>
                                    <h4 className="white-label px-2 py-1"><SiHtml5 /> HTML 5 </h4>
                                </li>
                                <li>
                                    <h4 className="white-label px-2 py-1"><SiSwift /> SWIFT </h4>
                                </li>
                                <li>
                                ...
                                <li>
                                    <h4 className="white-label px-2 py-1"><SiPython />PYTHON</h4>
                                </li>
                                <li>
                                    <h4 className="white-label px-2 py-1"><SiGithub /> GITHUB </h4>
                                </li>
                                <li>
                                    <h4 className="white-label px-2 py-1"><SiIos /> APPLE GENIUS </h4>
                                </li>
                                <li>
                                    <h4 className="white-label px-2 py-1"><SiSteam /> TEAM WORKER </h4>
                                </li>
